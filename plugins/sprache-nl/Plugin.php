<?php
// sprache-nl/Plugin.php
//
// Sprach-Addon: Niederländisch (Nederlands). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Nederlands" und einmal
// "Niederländisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-nl plugins/sprache-nl
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SpracheNl;
