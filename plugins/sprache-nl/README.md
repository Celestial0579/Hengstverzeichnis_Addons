...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Niederländisch
(Nederlands)**. Löst
...
Eine Datei: `lang/core/nl.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Nederlands" und einmal „Niederländisch" steht.
