<?php
// sprache-sv/Plugin.php
//
// Sprach-Addon: Schwedisch (Svenska). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Svenska" und einmal
// "Schwedisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-sv plugins/sprache-sv
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SpracheSv;
