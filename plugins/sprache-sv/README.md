...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Schwedisch
(Svenska)**. Löst
...
Eine Datei: `lang/core/sv.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Svenska" und einmal „Schwedisch" steht.
