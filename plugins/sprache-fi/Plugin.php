<?php
// sprache-fi/Plugin.php
//
// Sprach-Addon: Finnisch (Suomi). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Suomi" und einmal
// "Finnisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-fi plugins/sprache-fi
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SpracheFi;
