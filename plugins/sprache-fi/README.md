...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Finnisch
(Suomi)**. Löst
...
Eine Datei: `lang/core/fi.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Suomi" und einmal „Finnisch" steht.
