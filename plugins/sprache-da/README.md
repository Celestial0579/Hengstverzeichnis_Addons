...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Dänisch
(Dansk)**. Löst
...
Eine Datei: `lang/core/da.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Dansk" und einmal „Dänisch" steht.
