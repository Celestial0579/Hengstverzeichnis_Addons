<?php
// sprache-da/Plugin.php
//
// Sprach-Addon: Dänisch (Dansk). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Dansk" und einmal
// "Dänisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-da plugins/sprache-da
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SpracheDa;
