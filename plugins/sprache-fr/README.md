...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Französisch
(Français)**. Löst
...
Eine Datei: `lang/core/fr.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Français" und einmal „Französisch" steht.
