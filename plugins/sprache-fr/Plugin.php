<?php
// sprache-fr/Plugin.php
//
// Sprach-Addon: Französisch (Français). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Français" und einmal
// "Französisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-fr plugins/sprache-fr
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SpracheFr;
