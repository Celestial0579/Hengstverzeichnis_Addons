<?php
// sprache-pl/Plugin.php
//
// Sprach-Addon: Polnisch (Polski). Loest Framework#344 fuer diese Sprache.
//
...
// Schreibweise, und im Umschalter staende einmal "Polski" und einmal
// "Polnisch".
//
// Installation (lokal im Framework-Repo):
//   cp -r sprache-pl plugins/sprache-pl
// Danach unter Admin -> Plugins verwalten (/admin/plugins) aktivieren.

namespace Plugin\SprachePl;
