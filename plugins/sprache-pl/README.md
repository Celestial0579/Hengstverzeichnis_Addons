...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Polnisch
(Polski)**. Löst
...
Eine Datei: `lang/core/pl.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Polski" und einmal „Polnisch" steht.
