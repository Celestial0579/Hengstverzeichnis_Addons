...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Luxemburgisch
(Lëtzebuergesch)**. Löst
...
Eine Datei: `lang/core/lb.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Lëtzebuergesch" und einmal „Luxemburgisch" steht.
