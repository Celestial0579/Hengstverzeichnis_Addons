...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Tschechisch
(Čeština)**. Löst
...
Eine Datei: `lang/core/cs.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Čeština" und einmal „Tschechisch" steht.
