...
Ergänzt die Oberfläche des Hengstverzeichnisses um **Italienisch
(Italiano)**. Löst
...
Eine Datei: `lang/core/it.php`. Sonst nichts — keine Berechtigungen,
...
einmal „Italiano" und einmal „Italienisch" steht.
